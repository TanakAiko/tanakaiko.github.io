...
@Component({
  ...
  template: `
    <div class="fixed top-4 right-4 z-[200] space-y-2 max-w-sm w-full pointer-events-none">
        ...
        >
          <div class="flex items-start gap-3 p-4">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-sm text-gray-200" [class.mt-1]="notification.title">{{ notification.message }}</p>
            </div>
...
export class ToastComponent {
  ...
  getNotificationClasses(type: NotificationType): string {
    const baseClasses = 'rounded-lg shadow-xl backdrop-blur-md border';
